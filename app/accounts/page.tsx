                        ...
                        {editingId === account.id ? (
                          <div className="flex items-center justify-end gap-2">
                            <input
                              ...
                              step="0.01"
                              className="w-full sm:w-32 px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                            <button
