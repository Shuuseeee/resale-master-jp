      ...
      <div className={layout.container}>
        ...
        <div className="mt-8 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <div className="font-semibold">耗材管理</div>
          </Link>
          ...
          <Link
            href="/tax-report"
            className="bg-indigo-600 hover:bg-indigo-700 rounded-xl p-6 text-center transition-all transform hover:scale-105 shadow-lg text-white"
          >
            <svg className="w-12 h-12 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <div className="font-semibold">税务申报</div>
          </Link>
        </div>
      </div>
    </div>
