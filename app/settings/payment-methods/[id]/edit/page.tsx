  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-apple-bg dark:bg-apple-bgDark flex items-center justify-center">
        <div className="text-apple-gray-1">加载中...</div>
      </div>
    );
  }
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-apple-separator dark:border-apple-sepDark rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-apple-blue/30 focus:border-transparent"
                  required
                />
              </div>
